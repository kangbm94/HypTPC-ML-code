...
class Track :public TLorentzVector{
	...
	public: 
		...
		Track(int pid, int Q, double* par,int tid,double mom0_ = -1.,int nhits=-1,double firstHitT = - 9999){
			Q_  = Q;
			pid_= pid;
			tid_= tid;
...
class Recon{
	...
	public:
		...
		int GetDaughterNhit(int i){
			return DaughterNhits.at(i);
		}
